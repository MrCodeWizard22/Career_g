    ...
    <>
      {showModel && (
        <>
          ...
          <div
            className={` ${OfferCounsellingCSS.model} modal fade`}
            id="policies"
          ...
          >
            <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
              <div
                className={` ${OfferCounsellingCSS.modelBody}  modal-content`}
              >
                <div className="modal-header">
                  <h1
                    className={` ${OfferCounsellingCSS.modelTitle} modal-title fs-5`}
                    id="policiesLabel"
                  >
                    Instructions and Eligibility Crieteria
                  </h1>
                </div>
                <div className="modal-body">
                  <h5 className={OfferCounsellingCSS.modelLabels}>
                    Instructions:
                  </h5>
                  <p className={OfferCounsellingCSS.modelContent}>
                    Once the form is filled out, after verification from the
                    admin side, you will receive an email. This email will
                    confirm that the admin has verified your details.
                    Additionally, at the end of the process, your email will be
                    further verified through an OTP sent to your mailbox.
                  </p>
                  <h5 className={OfferCounsellingCSS.modelLabels}>
                    Eligibility Criteria:
                  </h5>
                  <p className={OfferCounsellingCSS.modelContent}>
                    The maximum qualification required to act as a counsellor on
                    our website is a master's degree (M.Phil) or a PhD.
                  </p>
                </div>
                <div className="modal-footer">
                  <button
                    type="button"
                    className={`${OfferCounsellingCSS.modelAcceptBtn} btn`}
                  ...
                  <button
                    type="button"
                    className={`${OfferCounsellingCSS.modelRejectBtn} btn`}
                    onClick={(event) => {
                      navigate("/");
                      location.reload();
                    }}
      ...
      <div className="form-container">
        ...
        >
          ...
          {stepCount == 1 && (
            <fieldset>
              <h2 className={`${OfferCounsellingCSS.fsTitle} fs-title`}>
                Provide your Personal Details
              </h2>
              <h3 className={`${OfferCounsellingCSS.fsSubTitle} fs-subtitle`}>
                This is step 1
              </h3>
              <input
                className={OfferCounsellingCSS.input}
                type="text"
                name="name"
              ...
              <input
                ...
                name="phoneNo"
                required
                placeholder="Phone number after +91- (e.g., 123456789)"
                pattern="\+\d{1,4}-\d{1,10}"
                title="Enter a valid phone number in the format: +91-number (e.g., +91-123456789)"
                value={offerCounsellorForm.phoneNo}
                onChange={(event) => {
                  const enteredNumber = event.target.value.replace(
                    /\+\d{1,4}-/,
                    ""
                  );
              ...
              />
              <div
                className={`${OfferCounsellingCSS.genderContainer} mt-2 mb-3  `}
              >
                <label className={OfferCounsellingCSS.genderLabel}>
                  Gender:{" "}
                </label>

                <input
                  className={`${OfferCounsellingCSS.radio} `}
                  type="radio"
                  name="gender"
                  value="male"
                ...
                />
                <label
                  className={OfferCounsellingCSS.genderRadioLabel}
                  htmlFor="male"
                >
                  Male
                </label>
              ...
              <label
                htmlFor="profilePic"
                className={OfferCounsellingCSS.cnicImg}
              >
              ...
              <button
                ...
                onClick={async (event) => {
                  ...
                  const emailVerify = emailPattern.test(
                    offerCounsellorForm.email
                  );

                  if (emailVerify) {
                    await dispatch(
                      checkCounsellorEmail(offerCounsellorForm.email)
                    );
                  } else {
                    event.preventDefault();
                    dispatch(
                  ...
                  if (!store.getState().offerCounselling.isEmailExist) {
                    ...
                    store.getState().offerCounselling.isEmailExist &&
                  ...
                  if (
                    (offerCounsellorForm.gender === "male" ||
                      offerCounsellorForm.gender === "female") &&
                    offerCounsellorForm.name !== "" &&
                    offerCounsellorForm.password !== "" &&
                    offerCounsellorForm.cnic !== "" &&
                    offerCounsellorForm.phoneNo !== "" &&
                    images.cnicFrontImg !== null &&
                    images.cnicBackImg !== null &&
          ...
          {stepCount == 2 && (
            <fieldset>
              <h2 className={`${OfferCounsellingCSS.fsTitle} fs-title`}>
                Provide your Qualification Details
              </h2>
              <h3 className={`${OfferCounsellingCSS.fsSubTitle} fs-subtitle`}>
                This is step 2
              </h3>
              <label
                ...
                className={OfferCounsellingCSS.qualification}
              >
                Select your Qualification
              </label>
              <br></br>
              <select
                className={` ${OfferCounsellingCSS.qualificationdropdown} mt-3 mb-3`}
                name="qualification"
              ...
              />
              <label
                htmlFor="transcriptImg"
                className={OfferCounsellingCSS.transcriptImg}
              >
                Upload Transcript Image according to qualification:
              </label>
              <br />
              <br />
              {images.transcript && (
              ...
              />
              <button
                className={`${OfferCounsellingCSS.actionButton} previous action-button`}
                onClick={(event) => {
                  event.preventDefault();
                  dispatch(
                    ErrorMsg({
              ...
              <button
                ...
                onClick={(event) => {
                  if (
                    images.transcript !== null &&
                    (offerCounsellorForm.qualification !== "M.Phil" ||
                      offerCounsellorForm.qualification !== "PHD") &&
          ...
          {stepCount == 3 && (
            <>
              <fieldset>
                <h2 className={`${OfferCounsellingCSS.fsTitle} fs-title`}>
                  Provide your Working Experience Details
                </h2>
                <h3 className={`${OfferCounsellingCSS.fsSubTitle} fs-subtitle`}>
                  This is step 3
                </h3>
                {offerCounsellorForm.workingExperience.map(
                  (workingExperienceData, index) => (
                    <fieldset key={index} className="mb-3">
                      <div
                        className={` ${OfferCounsellingCSS.workingContainer} d-flex align-items-center`}
                      >
                        <input
                          className={OfferCounsellingCSS.input}
                          type="text"
                      ...
                      <div
                        className={`${OfferCounsellingCSS.workingExperienceYearFields} d-flex align-items-center`}
                      >
                        <input
                          className={OfferCounsellingCSS.input}
                          type="text"
                      ...
                      <label
                        ...
                        className={OfferCounsellingCSS.certificateImg}
                      >
                        Upload Certificate Image according to your working
                        experience:
                      </label>
                      <br />
                ...
                <button
                  ...
                  onClick={async (event) => {
                    ...
                    offerCounsellorForm.workingExperience.forEach(
                      (workingExperienceData, index) => {
                    ...
                    if (allDetailsFilled) {
                      ...
                      if (!isEmailExist) {
                        ...
                        formData.append(
                          "offerCounsellorForm",
                          JSON.stringify(offerCounsellorForm)
                        );
                        ...
                        await dispatch(
                          sendVerificationEmail({
                            email: offerCounsellorForm.email,
                            name: offerCounsellorForm.name,
                          })
                        );
                ...
                <button
                  type="button"
                  className={` ${OfferCounsellingCSS.addBtn} btn `}
                  onClick={(e) => {
                ...
                {isLoading && (
                  <img
                    src={Loading}
                    className={OfferCounsellingCSS.loading}
                    alt="loading"
                  />
                )}
              </fieldset>
