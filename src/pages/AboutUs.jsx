...
import Team1 from "../assets/images/download1.jpeg";
      ...
      <div className={`p-5 mt-5 ${AboutUsCSS.aboutContainer}`}>
        <div className="d-flex flex-row justify-content-center row">
          <div className="col-md-6 m-auto">
            ...
            <p className={AboutUsCSS.missionDescription}>
              We are committed to offering comprehensive career guidance and
              counseling services through AI Chatbot technology. By embracing
              cutting-edge technology and collaborating with expert advisors, we
              aspire to facilitate informed decision-making, enabling
              individuals to navigate their career paths and achieve their
              professional aspirations.
            </p>
          </div>
          <div className={`col-md-6 ${AboutUsCSS.imageContainer}`}>
            <img
              className={AboutUsCSS.missionImage}
              src={Image1}
              alt="AboutUs_Image"
            />
          </div>
        ...
        <div className="row">
          {/* <div className={`col-sm-6 col-lg-3 ${AboutUsCSS.teamCards}`}>
            <div className={AboutUsCSS.team}>
              ...
              <div className={`${AboutUsCSS.face} ${AboutUsCSS.backFace}`}>
                <span className={AboutUsCSS.iconsLeft}>
                  <i className="fa-solid fa-quote-left"></i>
                </span>
                <div className={AboutUsCSS.testimonial}>
                  Excels in management, ensuring smooth project execution
                  through task division. A Full Stack development enthusiast,
                  she combines leadership with technical expertise.
                  <p className={AboutUsCSS.socialIcons}>
                    <a href="#">
                      <span className={AboutUsCSS.linkedIn}>
                        <i class="fa-brands fa-linkedin"></i>
                      </span>
                    </a>
                    <a href="#">
                      <span className={AboutUsCSS.gitHub}>
                        <i class="fa-brands fa-github"></i>
                      </span>
                    </a>
                  </p>
                </div>
                <span className={AboutUsCSS.iconsRight}>
          ...
          <div className={`col-sm-6 col-lg-3 ${AboutUsCSS.teamCards}`}>
            <div className={AboutUsCSS.team}>
              ...
              <div className={`${AboutUsCSS.face} ${AboutUsCSS.backFace}`}>
                ...
                <div className={AboutUsCSS.testimonial}>
                  Passionate about coding conventions, excels and back-end
                  development. Stays relaxed under pressure, ensuring quality
                  work.
                  <p className={AboutUsCSS.socialIcons}>
                    <a href="#">
                      <span className={AboutUsCSS.linkedIn}>
          ...
          <div className={`col-sm-6 col-lg-3 ${AboutUsCSS.teamCards}`}>
            <div className={AboutUsCSS.team}>
              ...
              <div className={`${AboutUsCSS.face} ${AboutUsCSS.backFace}`}>
                ...
                <div className={AboutUsCSS.testimonial}>
                  Enthusiastic about finding new tools to simplify workflows, a
                  motivated backend development specialist who consistently
          ...
          {/* <div className={AboutUsCSS.team}>
            ...
            <div className={`${AboutUsCSS.face} ${AboutUsCSS.backFace}`}>
              ...
              <div className={AboutUsCSS.testimonial}>
                Expert in browser searching, excels at finding solutions to
                project challenges. Always eager to learn something new.
                <p className={AboutUsCSS.socialIcons}>
                  <a href="#">
                    <span className={AboutUsCSS.linkedIn}>
                      <i class="fa-brands fa-linkedin"></i>
